...
from ai.tools.python.tool import PythonAstREPLTool
...
- cleanup code
- create tools?
- create a "fallback" for when the agent cannot find the answer in the dataset
- keyword?
'''
def create_pandas_dataframe_agent(
    ...
    **kwargs: Any,
    ...
    if agent_type == AgentType.ZERO_SHOT_REACT_DESCRIPTION:
        ...
        # )
        print("prompt", prompt)
        print("prompt input", prompt.input_variables)
        print("prompt partial", prompt.partial_variables)
